...
document.getElementById("file-upload").addEventListener("change", function () {
  ...
  if (this.files && this.files.length > 0) {
    ...
    // Encuentra el elemento para mostrar el nombre del archivo y actualiza su texto
    document.querySelector(".file-name-container").textContent = fileName;
  } else {
    // Si no se seleccionó ningún archivo, mantiene el mensaje predeterminado
    document.querySelector(".file-name-container").textContent =
