...
const mainController = {
  index: async (req, res) => {
    try {
      ...
      const grano = await productsService.getTopProduct(2);
      const molido = await productsService.getTopProduct(3);
      const capsula = await productsService.getTopProduct(4);
